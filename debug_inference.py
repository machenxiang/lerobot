...
if __name__ == "__main__":
    ...
    result = subprocess.run(
        [
            ...
            "--policy_path=/home/mcx/lerobot/outputs/smolvla_libero_finetune_0427/checkpoints/last/pretrained_model",
            "--task_suite_name=libero_spatial",
            "--num_trials_per_task=10",
            "--video_out_path=data/libero_200k/videos",
            "--output_csv_path=data/libero_200k/eval_results.csv",
            "--device=cuda",
            "--seed=7",
        ],
